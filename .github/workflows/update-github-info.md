...
- Mention the source of any update from the GitHub Blog or GitHub Changelog.
...
Use the GitHub Blog and GitHub Changelog as the main source material for updates to `site/content/github-info.md`.
